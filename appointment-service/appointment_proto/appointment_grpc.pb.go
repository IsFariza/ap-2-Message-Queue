...
const (
	AppointmentService_CreateAppointment_FullMethodName       = "/appointment_proto.AppointmentService/CreateAppointment"
	AppointmentService_GetAppointment_FullMethodName          = "/appointment_proto.AppointmentService/GetAppointment"
	AppointmentService_ListAppointments_FullMethodName        = "/appointment_proto.AppointmentService/ListAppointments"
	AppointmentService_UpdateAppointmentStatus_FullMethodName = "/appointment_proto.AppointmentService/UpdateAppointmentStatus"
)
...
//
// AppointmentService handles the scheduling and status management of appointments
type AppointmentServiceClient interface {
	// CreateAppointment schedules a new patient-doctor meeting
	CreateAppointment(ctx context.Context, in *CreateAppointmentRequest, opts ...grpc.CallOption) (*AppointmentResponse, error)
	// GetAppointment retrieves specific details by ID
	...
	// UpdateAppointmentStatus allows for transition between states
...
var AppointmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "appointment_proto.AppointmentService",
	...
	Metadata: "appointment_proto/appointment.proto",
}
